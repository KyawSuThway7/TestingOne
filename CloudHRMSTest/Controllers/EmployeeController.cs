...
namespace CloudHRMSTEST.Controllers
{
    ...
    public class EmployeeController : Controller
    {
        ...
        public IActionResult Entry()
        {
            ...
            var positions = _applicationDbContext.Positions.Select(s => new EmployeeViewModel
            {
                Id = s.Id,
                Code = s.Code
            }).OrderBy(o => o.Code).ToList();
        ...
        public IActionResult List()
        {
            IList<EmployeeViewModel> employees = (from e in _applicationDbContext.Employees
                                                  ...
                                                  //IList<EmployeeViewModel> employee = _applicationDbContext.Employees.Select(x => new EmployeeViewModel
                                                  {
                Id = e.Id,
                Code = e.Code,
                Name = e.Name,
                ...
                DepartmentInfo =d.Name, /*_applicationDbContext.Departments.Where(d => d.Id == x.DepartmentId).FirstOrDefault().Name,*/
                PositionInfo =p.Name/*_applicationDbContext.Positions.Where(d => d.Id == x.PositionId).FirstOrDefault().Name,*/
        ...
        {
            var department = _applicationDbContext.Departments.Select(x => new DepartmentViewModel
            {
                Id = x.Id,
                Code = x.Code,
            }).OrderBy(o => o.Code).ToList();
            var position = _applicationDbContext.Positions.Select(x => new EmployeeViewModel
            {
                Id = x.Id,
                Code = x.Code,
            }).OrderBy(o => o.Code).ToList();
            ...
            EmployeeViewModel employee = _applicationDbContext.Employees.Where(x => x.Id == id).Select(s => new EmployeeViewModel
            {
                ...
                //DepartmentInfo = _applicationDbContext.Departments.Where(d => d.Id == s.DepartmentId).FirstOrDefault().Name,
                //PositionInfo = _applicationDbContext.Positions.Where(d => d.Id == s.PositionId).FirstOrDefault().Name,

            }).SingleOrDefault();
            ViewBag.Department = department;
            ViewBag.Postion = position;
